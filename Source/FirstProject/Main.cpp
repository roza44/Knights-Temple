...
AMain::AMain()
{
	...
	// Don't when the controller rotates
	...
	GetCharacterMovement()->bOrientRotationToMovement = true; // Character moves i the direction of input
...
void AMain::Die()
{
	...
	if (AnimInstance && CombatMontage)
	{
		...
		AnimInstance->Montage_JumpToSection(FName("Deth"));
	}
